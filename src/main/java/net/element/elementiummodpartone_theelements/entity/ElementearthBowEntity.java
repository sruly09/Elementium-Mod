...
public class ElementearthBowEntity extends AbstractArrow implements ItemSupplier {
	public ElementearthBowEntity(PlayMessages.SpawnEntity packet, Level world) {
		super(Elementiummodpart1TheelementsModEntities.ELEMENTEARTH_BOW.get(), world);
	}
	...
	public ItemStack getItem() {
		return new ItemStack(Elementiummodpart1TheelementsModItems.EARTH_ESSENCE.get());
	}
	...
	public static ElementearthBowEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
		ElementearthBowEntity entityarrow = new ElementearthBowEntity(Elementiummodpart1TheelementsModEntities.ELEMENTEARTH_BOW.get(), entity, world);
	...
	public static ElementearthBowEntity shoot(LivingEntity entity, LivingEntity target) {
		ElementearthBowEntity entityarrow = new ElementearthBowEntity(Elementiummodpart1TheelementsModEntities.ELEMENTEARTH_BOW.get(), entity, entity.level);
