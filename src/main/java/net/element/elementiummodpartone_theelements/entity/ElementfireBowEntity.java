...
public class ElementfireBowEntity extends AbstractArrow implements ItemSupplier {
	public ElementfireBowEntity(PlayMessages.SpawnEntity packet, Level world) {
		super(Elementiummodpart1TheelementsModEntities.ELEMENTFIRE_BOW.get(), world);
	}
	...
	public ItemStack getItem() {
		return new ItemStack(Elementiummodpart1TheelementsModItems.FIRE_ESSENCE.get());
	}
	...
	public static ElementfireBowEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
		ElementfireBowEntity entityarrow = new ElementfireBowEntity(Elementiummodpart1TheelementsModEntities.ELEMENTFIRE_BOW.get(), entity, world);
	...
	public static ElementfireBowEntity shoot(LivingEntity entity, LivingEntity target) {
		ElementfireBowEntity entityarrow = new ElementfireBowEntity(Elementiummodpart1TheelementsModEntities.ELEMENTFIRE_BOW.get(), entity, entity.level);
