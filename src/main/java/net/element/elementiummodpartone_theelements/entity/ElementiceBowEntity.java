...
import net.element.elementiummodpartone_theelements.procedures.ElementiceBowProjectileHitsLivingEntityProcedure;
...
public class ElementiceBowEntity extends AbstractArrow implements ItemSupplier {
	public ElementiceBowEntity(PlayMessages.SpawnEntity packet, Level world) {
		super(Elementiummodpart1TheelementsModEntities.ELEMENTICE_BOW.get(), world);
	}

	public ElementiceBowEntity(EntityType<? extends ElementiceBowEntity> type, Level world) {
		super(type, world);
	}

	public ElementiceBowEntity(EntityType<? extends ElementiceBowEntity> type, double x, double y, double z, Level world) {
		super(type, x, y, z, world);
	}

	public ElementiceBowEntity(EntityType<? extends ElementiceBowEntity> type, LivingEntity entity, Level world) {
	...
	public static ElementiceBowEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
		ElementiceBowEntity entityarrow = new ElementiceBowEntity(Elementiummodpart1TheelementsModEntities.ELEMENTICE_BOW.get(), entity, world);
	...
	public static ElementiceBowEntity shoot(LivingEntity entity, LivingEntity target) {
		ElementiceBowEntity entityarrow = new ElementiceBowEntity(Elementiummodpart1TheelementsModEntities.ELEMENTICE_BOW.get(), entity, entity.level);
