...
import net.element.elementiummodpartone_theelements.procedures.ElementairBowProjectileHitsLivingEntityProcedure;
...
public class ElementairBowEntity extends AbstractArrow implements ItemSupplier {
	public ElementairBowEntity(PlayMessages.SpawnEntity packet, Level world) {
		super(Elementiummodpart1TheelementsModEntities.ELEMENTAIR_BOW.get(), world);
	}
	...
	public ItemStack getItem() {
		return new ItemStack(Elementiummodpart1TheelementsModItems.AIR_ESSENCE.get());
	}
	...
	public static ElementairBowEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
		ElementairBowEntity entityarrow = new ElementairBowEntity(Elementiummodpart1TheelementsModEntities.ELEMENTAIR_BOW.get(), entity, world);
	...
	public static ElementairBowEntity shoot(LivingEntity entity, LivingEntity target) {
		ElementairBowEntity entityarrow = new ElementairBowEntity(Elementiummodpart1TheelementsModEntities.ELEMENTAIR_BOW.get(), entity, entity.level);
