...
public class ElementfirePickaxeBlockDestroyedWithToolProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		boolean removeBlock = false;
		boolean removeItem = false;
		if (Elementiummodpart1TheelementsModItems.ELEMENTFIRE_PICKAXE.get().isCorrectToolForDrops((world.getBlockState(new BlockPos(x, y, z)))) == true) {
