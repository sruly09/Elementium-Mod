...
public class ElementairPickaxeItem extends PickaxeItem {
	public ElementairPickaxeItem() {
		super(new Tier() {
			public int getUses() {
				return 1122;
			}
		...
		}, 1, -2.8f, new Item.Properties().tab(Elementiummodpart1TheelementsModTabs.TAB_ELEMENTIUM_TAB));
	}
