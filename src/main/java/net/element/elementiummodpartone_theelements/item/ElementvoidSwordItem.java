...
import net.element.elementiummodpartone_theelements.procedures.ElementvoidSwordLivingEntityIsHitWithToolProcedure;
...
public class ElementvoidSwordItem extends SwordItem {
	public ElementvoidSwordItem() {
		...
		}, 3, -2f, new Item.Properties().tab(Elementiummodpart1TheelementsModTabs.TAB_ELEMENTIUM_TAB).fireResistant());
	}
