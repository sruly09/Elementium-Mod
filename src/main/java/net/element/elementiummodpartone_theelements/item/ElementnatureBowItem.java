...
public class ElementnatureBowItem extends Item {
	public ElementnatureBowItem() {
		super(new Item.Properties().tab(Elementiummodpart1TheelementsModTabs.TAB_ELEMENTIUM_TAB).durability(1212));
	}
		...
		if (!world.isClientSide() && entityLiving instanceof ServerPlayer entity) {
			...
			if (true) {
				...
				if (entity.getAbilities().instabuild || stack != ItemStack.EMPTY) {
					ElementnatureBowEntity entityarrow = ElementnatureBowEntity.shoot(world, entity, world.getRandom(), 4.199999999999999f, 4, 5);
