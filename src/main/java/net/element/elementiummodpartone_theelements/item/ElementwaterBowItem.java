...
public class ElementwaterBowItem extends Item {
	public ElementwaterBowItem() {
		super(new Item.Properties().tab(Elementiummodpart1TheelementsModTabs.TAB_ELEMENTIUM_TAB).durability(1569));
	}
		...
		if (!world.isClientSide() && entityLiving instanceof ServerPlayer entity) {
			...
			if (true) {
				...
				if (entity.getAbilities().instabuild || stack != ItemStack.EMPTY) {
					ElementwaterBowEntity entityarrow = ElementwaterBowEntity.shoot(world, entity, world.getRandom(), 1.3f, 9.8, 7);
