...
import net.element.elementiummodpartone_theelements.procedures.ElementwaterSwordLivingEntityIsHitWithToolProcedure;
...
public class ElementwaterSwordItem extends SwordItem {
	public ElementwaterSwordItem() {
		...
		}, 3, 0.2f, new Item.Properties().tab(Elementiummodpart1TheelementsModTabs.TAB_ELEMENTIUM_TAB));
	}
