...
import net.element.elementiummodpartone_theelements.procedures.ElementfireAxeBlockDestroyedWithToolProcedure;
...
public class ElementfireAxeItem extends AxeItem {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.literal("Autosmelts blocks to there smelted form (log = charcoal)"));
	}
}
