...
import net.element.elementiummodpartone_theelements.procedures.ElementairArmorLeggingsTickEventProcedure;
import net.element.elementiummodpartone_theelements.procedures.ElementairArmorHelmetTickEventProcedure;
import net.element.elementiummodpartone_theelements.procedures.ElementairArmorBootsTickEventProcedure;
import net.element.elementiummodpartone_theelements.procedures.ElementairArmorBodyTickEventProcedure;
...
public abstract class ElementairArmorItem extends ArmorItem {
	public ElementairArmorItem(EquipmentSlot slot, Item.Properties properties) {
		super(new ArmorMaterial() {
			...
			public int getDefenseForSlot(EquipmentSlot slot) {
				return new int[]{8, 5, 6, 6}[slot.getIndex()];
			}
	...
	public static class Helmet extends ElementairArmorItem {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "elementiummodpart1_theelements:textures/models/armor/elementair__layer_1.png";
		}
	...
	public static class Leggings extends ElementairArmorItem {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "elementiummodpart1_theelements:textures/models/armor/elementair__layer_2.png";
		}
