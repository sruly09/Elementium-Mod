...
import net.element.elementiummodpartone_theelements.procedures.ElementfireSwordLivingEntityIsHitWithToolProcedure;
...
public class ElementfireSwordItem extends SwordItem {
	public ElementfireSwordItem() {
		...
		}, 3, -2.4000000000000001f, new Item.Properties().tab(Elementiummodpart1TheelementsModTabs.TAB_ELEMENTIUM_TAB).fireResistant());
	}
