...
public class ElementfireBowItem extends Item {
	public ElementfireBowItem() {
		super(new Item.Properties().tab(Elementiummodpart1TheelementsModTabs.TAB_ELEMENTIUM_TAB).durability(750));
	}
		...
		if (!world.isClientSide() && entityLiving instanceof ServerPlayer entity) {
			...
			if (true) {
				...
				if (entity.getAbilities().instabuild || stack != ItemStack.EMPTY) {
					ElementfireBowEntity entityarrow = ElementfireBowEntity.shoot(world, entity, world.getRandom(), 1.1f, 4.4, 2);
