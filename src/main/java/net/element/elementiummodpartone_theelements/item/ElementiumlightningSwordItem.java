...
import net.element.elementiummodpartone_theelements.procedures.ElementlighningSwordLivingEntityIsHitWithToolProcedure;
...
public class ElementiumlightningSwordItem extends SwordItem {
	public ElementiumlightningSwordItem() {
		...
		}, 3, -1.6999999999999997f, new Item.Properties().tab(Elementiummodpart1TheelementsModTabs.TAB_ELEMENTIUM_TAB).fireResistant());
	}
