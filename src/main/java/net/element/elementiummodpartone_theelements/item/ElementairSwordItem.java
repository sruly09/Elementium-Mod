...
import net.element.elementiummodpartone_theelements.procedures.ElementairSwordLivingEntityIsHitWithToolProcedure;
...
public class ElementairSwordItem extends SwordItem {
	public ElementairSwordItem() {
		...
		}, 3, -2.8f, new Item.Properties().tab(Elementiummodpart1TheelementsModTabs.TAB_ELEMENTIUM_TAB));
	}
