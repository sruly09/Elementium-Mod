...
public class ElementvoidBowItem extends Item {
	public ElementvoidBowItem() {
		super(new Item.Properties().tab(Elementiummodpart1TheelementsModTabs.TAB_ELEMENTIUM_TAB).durability(9110));
	}
		...
		if (!world.isClientSide() && entityLiving instanceof ServerPlayer entity) {
			...
			if (true) {
				...
				if (entity.getAbilities().instabuild || stack != ItemStack.EMPTY) {
					ElementvoidBowEntity entityarrow = ElementvoidBowEntity.shoot(world, entity, world.getRandom(), 1.2f, 4.699999999999999, 3);
