...
public class ElementfireBowItem extends Item {
	public ElementfireBowItem() {
		super(new Item.Properties().tab(ElementiumModModTabs.TAB_ELEMENTIUM_TAB).durability(750));
	}
		...
		if (!world.isClientSide() && entityLiving instanceof ServerPlayer entity) {
			...
			if (true) {
				...
				if (entity.getAbilities().instabuild || stack != ItemStack.EMPTY) {
					ElementfireBowEntity entityarrow = ElementfireBowEntity.shoot(world, entity, world.getRandom(), 1f, 5.8999999999999995, 3);
