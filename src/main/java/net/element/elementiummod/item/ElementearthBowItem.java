...
public class ElementearthBowItem extends Item {
	public ElementearthBowItem() {
		super(new Item.Properties().tab(ElementiumModModTabs.TAB_ELEMENTIUM_TAB).durability(3355));
	}
		...
		if (!world.isClientSide() && entityLiving instanceof ServerPlayer entity) {
			...
			if (true) {
				...
				if (entity.getAbilities().instabuild || stack != ItemStack.EMPTY) {
					ElementearthBowEntity entityarrow = ElementearthBowEntity.shoot(world, entity, world.getRandom(), 1.2000000000000002f, 40, 6);
