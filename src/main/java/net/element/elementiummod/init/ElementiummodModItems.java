...
import net.element.elementiummod.item.BlazingSteakItem;
...
public class ElementiummodModItems {
	...
	public static final RegistryObject<Item> BLAZING_STEAK = REGISTRY.register("blazing_steak", () -> new BlazingSteakItem());
