...
public class ElementiceBowEntity extends AbstractArrow implements ItemSupplier {
	public ElementiceBowEntity(PlayMessages.SpawnEntity packet, Level world) {
		super(ElementiumModModEntities.ELEMENTICE_BOW.get(), world);
	}
	...
	public static ElementiceBowEntity shoot(LivingEntity entity, LivingEntity target) {
		ElementiceBowEntity entityarrow = new ElementiceBowEntity(ElementiumModModEntities.ELEMENTICE_BOW.get(), entity, entity.level);
