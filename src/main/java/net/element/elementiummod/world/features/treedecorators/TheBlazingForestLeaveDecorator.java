...
public class TheBlazingForestLeaveDecorator extends LeaveVineDecorator {
	public static Codec<LeaveVineDecorator> CODEC = Codec.unit(TheBlazingForestLeaveDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(ForgeRegistries.Keys.TREE_DECORATOR_TYPES, registerHelper -> registerHelper.register("the_blazing_forest_tree_leave_decorator", DECORATOR_TYPE));
	}

	public TheBlazingForestLeaveDecorator() {
		super(0.25f);
	}
