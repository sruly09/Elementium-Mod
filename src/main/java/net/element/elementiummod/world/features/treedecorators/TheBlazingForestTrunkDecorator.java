...
public class TheBlazingForestTrunkDecorator extends TrunkVineDecorator {
	public static Codec<TheBlazingForestTrunkDecorator> CODEC = Codec.unit(TheBlazingForestTrunkDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(ForgeRegistries.Keys.TREE_DECORATOR_TYPES, registerHelper -> registerHelper.register("the_blazing_forest_tree_trunk_decorator", DECORATOR_TYPE));
	}
