...
package net.element.elementiummod.world.features.treedecorators;
...
public class TheBlazingForestFruitDecorator extends CocoaDecorator {
	public static Codec<TheBlazingForestFruitDecorator> CODEC = Codec.unit(TheBlazingForestFruitDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(ForgeRegistries.Keys.TREE_DECORATOR_TYPES, registerHelper -> registerHelper.register("the_blazing_forest_tree_fruit_decorator", DECORATOR_TYPE));
	}
