...
package net.element.elementiummod.world.biome;
...
public class ElementiumBiome {
	public static Biome createBiome() {
		...
		mobSpawnInfo.addSpawn(MobCategory.MISC, new MobSpawnSettings.SpawnerData(EntityType.WITHER_SKELETON, 14, 3, 4));
